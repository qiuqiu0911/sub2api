          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <div
                  v-if="deviceAuthorization && deviceUserCode"
                  class="mt-3 rounded border border-blue-300 bg-blue-50 p-3 text-center dark:border-blue-600 dark:bg-blue-900/30"
                >
                  <p class="text-xs text-blue-700 dark:text-blue-300">设备验证码</p>
                  <p class="mt-1 font-mono text-2xl font-semibold tracking-widest text-blue-900 dark:text-blue-100">
                    {{ deviceUserCode }}
                  </p>
                  <p class="mt-2 text-xs text-blue-700 dark:text-blue-300">
                    {{ devicePolling ? '等待浏览器授权完成…' : '请打开上方链接并输入验证码' }}
                  </p>
                </div>
