...
// defaultKiroIDEUserAgentVersion 是当前 KRS endpoint 使用的稳定版 Kiro IDE 版本号。
// 上游会根据客户端版本下发可用模型，版本过旧时新模型可能返回 INVALID_MODEL_ID。
const defaultKiroIDEUserAgentVersion = "1.0.182"
...
var kiroIDEUserAgentVersion = func() string {
	...
	return defaultKiroIDEUserAgentVersion
}()
