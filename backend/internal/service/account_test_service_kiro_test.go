...
func TestAccountTestService_KiroUsesKiroUpstreamInsteadOfAnthropic(t *testing.T) {
	...
	require.Contains(t, string(body), `"profileArn":"arn:aws:codewhisperer:us-east-1:123456789012:profile/TESTSOCIAL"`)
...
func TestBuildKiroPayloadForAccount_KiroBuilderIDWithRealProfileArnIncludesForQMode(t *testing.T) {
	account := &Account{
		ID:       33,
