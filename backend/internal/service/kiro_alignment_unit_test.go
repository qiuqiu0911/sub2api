...
func TestGetModelPricing_KiroClaudeModelsUseDedicatedFallbacks(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "claude-sonnet-5", inputPrice: 3e-6, outputPrice: 15e-6},
		{model: "claude-sonnet-4-6", inputPrice: 3e-6, outputPrice: 15e-6},
		{model: "claude-haiku-4-5", inputPrice: 1e-6, outputPrice: 5e-6},
	}
